...
POOL_EXOPRT bool extractEntity(uint64 guid, const string & stream, GOOGLE_MESSAGE_TYPE * * entity_msg);
...
public:
	...
	virtual GOOGLE_MESSAGE_TYPE * getWhileFlush(uint64 guid) = 0;	// get entity and set flush state
