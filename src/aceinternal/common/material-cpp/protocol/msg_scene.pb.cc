...
void protobuf_AssignDesc_protocol_2fmsg_5fscene_2eproto() {
  protobuf_AddDesc_protocol_2fmsg_5fscene_2eproto();
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_protocol_2fmsg_5fscene_2eproto);
}
...
void protobuf_AddDesc_protocol_2fmsg_5fscene_2eproto() {
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_protocol_2fmsg_5fscene_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_protocol_2fmsg_5fscene_2eproto {
  StaticDescriptorInitializer_protocol_2fmsg_5fscene_2eproto() {
    protobuf_AddDesc_protocol_2fmsg_5fscene_2eproto();
  }
} static_descriptor_initializer_protocol_2fmsg_5fscene_2eproto_;
...
const scene_xs2ns_req_online_scenes& scene_xs2ns_req_online_scenes::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_protocol_2fmsg_5fscene_2eproto();
