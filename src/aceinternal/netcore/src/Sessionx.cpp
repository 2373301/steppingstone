...
int Sessionx::handle_input(ACE_HANDLE  fd)
{
	return rd_stream();
}

int Sessionx::handle_output(ACE_HANDLE  fd)
{
...
int Sessionx::handle_close(ACE_HANDLE handle, ACE_Reactor_Mask close_mask)
{
...
int Sessionx::close(ACE_Reactor_Mask close_mask)
{
...
void Sessionx::setHandleInput(HandleInputx * a_input)
{
	m_handle_input = a_input;
}

void Sessionx::recvError(int recv_value, int last_error)
{

}

void Sessionx::initBufferError(int last_error)
{

}

void Sessionx::setSavePackInfo(bool is_save, const string & file_name)
{
	//m_save_input_pack_info.init(is_save, file_name);
	m_save_input_pack_info.init(false, file_name);
}

int Sessionx::net_connected()
{
	return 0;
}

int Sessionx::net_closed()
{
	return 0;
}

void Sessionx::parseInputPacket()
{
	while (true)
	{
